...
import { createAssetMetadata } from '../../utils/ipfsUpload';

const CreateView = () => {
  // Add isAdminUser to the destructuring
...
//      }
 //   };
  ...
  // Connection check - must be after all hooks
  if (!isConnected) {
    return (
  ...
  const validateStep = (step) => {
    ...
    setErrors(prev => ({ ...prev, assetImageUrl: 'Please upload a main image' }));
    return;
  }
  ...
  <ImageUploadSection 
    onImagesChange={(images) => {
      ...
      // Update formData with the main image URL for backward compatibility
      if (images.mainImage) {
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-400 font-light">Please connect your wallet to view tokenized assets</p>
        </div>
      </div>
    );
  }
