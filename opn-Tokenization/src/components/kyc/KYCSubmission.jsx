      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="p-4 bg-neutral-900/50 border border-neutral-800 rounded-lg">
          <p className="text-sm text-neutral-300">
            ...
            Once approved, you'll be able to create Tokenization requests.
          </p>
        </div>
      </div>
    );
    ...
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <p className="body-text">
          To create Tokenization requests, you need to complete our Know Your Customer (KYC) 
          verification process. This helps us maintain regulatory compliance and protect all users.
        </p>
      </div>

      <div className="mb-8 p-4 bg-yellow-900/20 border border-yellow-900/50 rounded-lg">
