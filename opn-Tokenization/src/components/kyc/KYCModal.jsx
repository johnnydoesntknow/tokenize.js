...
const KYCModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-black border border-neutral-900 rounded-lg max-w-md w-full p-6">
        {/* Close button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 hover:bg-neutral-900 rounded-lg transition-colors"
        >
          <X className="w-5 h-5" />
        </button>
