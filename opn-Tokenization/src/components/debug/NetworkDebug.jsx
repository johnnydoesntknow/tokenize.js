...
const NetworkDebug = () => {
  ...
  }, [address, isConnected, chainId, provider, Tokenization, kyc, network]);

  return (
    <div className="fixed bottom-20 right-4 bg-black border border-neutral-800 rounded-lg p-4 max-w-sm text-xs font-mono">
      <h3 className="text-white mb-2">Network Debug</h3>
      <div className="space-y-1 text-neutral-400">
        <p>Chain ID: {chainId || 'null'}</p>
        <p>Expected: 984 (OPN)</p>
        <p>Contracts: {Tokenization ? '✅' : '❌'}</p>
