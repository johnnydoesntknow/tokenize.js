...
const ManualRoleCheck = () => {
  ...
  const checkRole = async () => {
    ...
    try {
      ...
      const contract = new ethers.Contract(contractAddress, Tokenization_ABI, signer);
  ...
  return (
    <div className="fixed top-24 right-4 bg-black border border-neutral-800 rounded-lg p-4 max-w-sm">
