    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="md:hidden absolute top-4 right-4 p-2 hover:bg-neutral-900 rounded-lg transition-colors"
        >
          ...
          {isConnected && address ? (
            ...
            <>
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-neutral-900/50 transition-colors"
              >
