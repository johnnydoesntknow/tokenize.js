...
// PHASE 3: Reusable document input component
const DocumentInput = ({ 
  label, 
  value, 
  onChange, 
...
{/* FIXED: Additional Document URL field (was accidentally removed) */}
<DocumentInput
...
{/* PHASE 3: Additional Documents Section */}
