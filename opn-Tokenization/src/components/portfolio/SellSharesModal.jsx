...
const SellSharesModal = ({ isOpen, onClose, asset, onSellComplete }) => {
  ...
  const bothInputsFilled = useMemo(() => {
    return amount && listingPrice && parseFloat(amount) > 0 && parseFloat(listingPrice) > 0;
  }, [amount, listingPrice]);
  
  // Check approval status ONLY when both inputs are filled
  useEffect(() => {
    const checkApproval = async () => {
      if (!positionNFT || !secondaryMarket || !address || !isOpen || !bothInputsFilled) {
    ...
    checkApproval();
  }, [positionNFT, secondaryMarket, address, isOpen, bothInputsFilled]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-black border border-neutral-900 rounded-lg max-w-md w-full">
        {/* Header */}
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                min="0"
                max={maxAmount}
                className="w-full px-4 py-3 bg-neutral-950 border border-neutral-800 rounded-lg text-white focus:outline-none focus:border-neutral-700 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
              />
          ...
          {/*STEP 2: APPROVAL SECTION (only shown after both inputs filled) */}
          {bothInputsFilled && (
            <>
              {checkingApproval ? (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-neutral-400 mt-1">
                        Ready to list your position for sale!
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              onClick={handleList}
              disabled={selling || !isApproved || !bothInputsFilled}
