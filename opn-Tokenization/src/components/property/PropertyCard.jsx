  ...
  return (
    <>
      <div className="card-hover group h-full flex flex-col">
        ...
        <div className="relative aspect-[4/3] bg-neutral-950 overflow-hidden">
          ...
          <div className="absolute top-4 left-4">
            <span className="px-3 py-1 bg-black/80 backdrop-blur-sm text-white text-xs uppercase tracking-wider rounded-lg">
              {property.assetType}
            </span>
          </div>
          {property.requiresPurchaserKYC && (
            <div className="absolute top-4 right-4">
              <div className="p-2 bg-black/80 backdrop-blur-sm rounded-lg">
          ...
          <div className="absolute bottom-4 left-4">
            <span className={`px-2 py-1 text-xs font-light rounded-lg ${
              isWeighted 
      ...
      {showFullDescription && (
        ...
        >
          <div 
            className="bg-neutral-950 border border-neutral-800 rounded-lg p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto"
