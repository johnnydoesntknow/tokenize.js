        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-light tracking-tight mb-6 animate-fadeIn">
              ...
              <span className="block text-neutral-400">Through Tokenization</span>
            </h1>
              ...
              <div key={index} className="relative">
                <div className="text-center lg:text-left">
                  <div className="inline-flex items-center justify-center w-24 h-24 
                                border border-neutral-800 rounded-lg mb-6">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group cursor-pointer">
              <div className="aspect-square bg-neutral-900 rounded-lg overflow-hidden mb-4">
                <img 
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-4 md:mb-0 text-center md:text-left">
              <h3 className="text-xl font-light mb-2">OPN Tokenization</h3>
          ...
          <div className="mt-8 pt-8 border-t border-neutral-900 text-center text-xs text-neutral-600">
            © 2025 OPN Tokenization. Built on OPN Chain.
          </div>
        </div>
      </footer>
    </div>
