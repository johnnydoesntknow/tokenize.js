      ...
      <div className="relative" style={{ zIndex: 1 }}>
        <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-12 max-w-[1400px] mx-auto">
                ...
                {categories.map((category) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {count > 0 && (
                        <span className={`
                          px-1 sm:px-1.5 py-0.5 text-[9px] sm:text-[10px] md:text-xs rounded-lg
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 md:gap-6 mb-4 sm:mb-6 md:mb-12">
            <div className="bg-black/50 backdrop-blur-sm p-3 sm:p-4 md:p-6 border rounded-lg" style={{borderColor: 'rgba(34, 128, 205, 0.3)'}}>
