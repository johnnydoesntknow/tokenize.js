                ...
                <div className="aspect-video bg-neutral-900 overflow-hidden relative flex-shrink-0">
                  ...
                  <div className="absolute top-3 left-3 flex gap-2">
                    {listing.isPartialSale && (
                      <div className="px-3 py-1 bg-blue-600 text-white text-xs font-normal rounded-lg">
                        Partial
                      </div>
                    )}
                    {listing.isWeighted && (
                      <div className="px-3 py-1 bg-purple-600 text-white text-xs font-normal rounded-lg">
                        Weighted
                      </div>
                    )}
                  </div>
                  ...
                  {listing.seller.toLowerCase() === address?.toLowerCase() && (
                    <div className="absolute top-3 right-3 px-3 py-1 bg-green-600 text-white text-xs font-normal rounded-lg">
                      Your Listing
                    </div>
                  )}
                </div>
              ...
              >
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="w-full md:w-48 h-32 bg-neutral-900 rounded-lg overflow-hidden flex-shrink-0 relative">
                    ...
                    {listing.seller.toLowerCase() === address?.toLowerCase() && (
                      <div className="absolute top-2 right-2 px-2 py-1 bg-green-600 text-white text-xs rounded-lg">
                        Yours
                      </div>
                    )}
                  </div>
