        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="w-full md:w-48 h-32 bg-neutral-900 rounded-lg overflow-hidden flex-shrink-0 relative">
            ...
            <div className="absolute top-2 left-2">
              <span className="px-2 py-1 bg-black/90 backdrop-blur-sm text-white text-xs font-semibold rounded-lg border border-white/20">
                {asset.assetType}
              </span>
            </div>
            
            <div className="absolute top-2 right-2 flex gap-1">
              <span className="px-2 py-1 bg-black/90 backdrop-blur-sm text-white text-xs font-semibold rounded-lg border border-white/20 flex items-center gap-1">
                <Check className="w-3 h-3" />
                Verified
              </span>
              <span className={`px-2 py-1 backdrop-blur-sm text-xs font-semibold rounded-lg border ${
                isWeighted 
    ...
    >
      ...
      <div className="aspect-video bg-neutral-900 overflow-hidden relative flex-shrink-0">
        ...
        <div className="absolute top-3 left-3">
          <span className="px-3 py-1 bg-black/90 backdrop-blur-sm text-xs font-semibold text-white rounded-lg border border-white/20 shadow-lg">
            {asset.assetType}
          </span>
        </div>
        ...
        <div className="absolute top-3 right-3 flex gap-2">
          <span className="px-2 py-1 bg-black/90 backdrop-blur-sm text-xs font-semibold text-white border border-white/20 rounded-lg flex items-center gap-1 shadow-lg">
            <Check className="w-3 h-3" />
            Verified
          </span>
          <span className={`px-3 py-1 backdrop-blur-sm text-xs font-semibold rounded-lg shadow-lg border ${
            isWeighted 
              ? 'bg-black/90 text-green-400 border-green-400/30' 
              : 'bg-black/90 text-blue-400 border-blue-400/30'
          }`}>
